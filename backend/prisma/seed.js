...
async function main() {
  ...
  const [woodenLegs, tableTop, diningTop, screws, chairFrame, chairCushion, shelfBoard, shelfBracket] = await Promise.all([
    prisma.product.create({ data: { name: 'Wooden Legs', description: 'Strong hardwood legs for furniture', salesPrice: 80, costPrice: 50, onHandQty: 200, reservedQty: 0, minStockLevel: 40, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Table Top (Standard)', description: 'Standard 4x2 ft wooden table top', salesPrice: 300, costPrice: 200, onHandQty: 30, reservedQty: 0, minStockLevel: 8, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Dining Top (Large)', description: 'Large 5x3 ft dining table top', salesPrice: 400, costPrice: 250, onHandQty: 10, reservedQty: 0, minStockLevel: 5, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Screws (M6x30)', description: 'Standard M6 furniture screws', salesPrice: 3, costPrice: 2, onHandQty: 500, reservedQty: 0, minStockLevel: 100, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Chair Frame', description: 'Steel/wood chair base frame', salesPrice: 400, costPrice: 300, onHandQty: 20, reservedQty: 0, minStockLevel: 5, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Chair Cushion', description: 'High-density foam chair cushion', salesPrice: 200, costPrice: 150, onHandQty: 20, reservedQty: 0, minStockLevel: 5, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Shelf Board', description: 'Plywood shelf board 3x1 ft', salesPrice: 220, costPrice: 180, onHandQty: 40, reservedQty: 0, minStockLevel: 10, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Shelf Bracket', description: 'Steel L-bracket for shelf support', salesPrice: 40, costPrice: 30, onHandQty: 80, reservedQty: 0, minStockLevel: 20, productType: 'component', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: false, canBePurchased: true, unit: 'pcs' } }),
  ]);
  console.log('✅ Created 8 component products');

  // ── Finished Products ──────────────────────────────────
  const [woodenTable, officeChair, diningTable, woodenShelf] = await Promise.all([
    prisma.product.create({ data: { name: 'Wooden Table', description: 'Premium hardwood office/home table', salesPrice: 2500, costPrice: 1200, onHandQty: 2, reservedQty: 0, minStockLevel: 3, productType: 'finished', procurementType: 'MTO', procurementRoute: 'manufacturing', canBeSold: true, canBePurchased: false, canBeManufactured: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Office Chair', description: 'Ergonomic office chair with cushion', salesPrice: 1800, costPrice: 700, onHandQty: 15, reservedQty: 0, minStockLevel: 5, productType: 'finished', procurementType: 'MTS', procurementRoute: 'purchase', canBeSold: true, canBePurchased: true, canBeManufactured: false, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Dining Table', description: 'Large family dining table (6-seater)', salesPrice: 4500, costPrice: 2000, onHandQty: 0, reservedQty: 0, minStockLevel: 2, productType: 'finished', procurementType: 'MTO', procurementRoute: 'manufacturing', canBeSold: true, canBePurchased: false, canBeManufactured: true, unit: 'pcs' } }),
    prisma.product.create({ data: { name: 'Wooden Shelf', description: '3-tier wooden display shelf', salesPrice: 1200, costPrice: 500, onHandQty: 8, reservedQty: 0, minStockLevel: 3, productType: 'finished', procurementType: 'MTS', procurementRoute: 'manufacturing', canBeSold: true, canBePurchased: false, canBeManufactured: true, unit: 'pcs' } }),
  ]);
